...
Fitting a line to this data is not great because the data is categorical, and this model is underfitting the data. There are a lot of points that are not represented by the model, which means that using this model would not lead to very accurate predictions for prices based on the package the pumpkins come in. 
