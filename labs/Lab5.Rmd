...
rf_accuracy <- accuracy(rf_predict, truth = partner_id, estimate = .pred_class) #get accuracy of testing prediction


compare_models <- data.frame(model = c("knn", "decision_tree", "bag_tree", "random_forest"), 
                             accuracy = c(knn_accuracy$.estimate, 0.7200000, 0.7600000, rf_accuracy$.estimate),
                             roc_auc = c(NA, 0.7195513, 0.8259215, NA))
