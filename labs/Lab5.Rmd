...
accuracy(feature_predict_knn, truth = partner_id,
         estimate = .pred_class)

sensitivity(feature_predict_knn, truth = partner_id, estimate = .pred_class)
specificity(feature_predict_knn, truth = partner_id, estimate = .pred_class)
