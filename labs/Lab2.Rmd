---
title: "HerschenfeldCatalan_Lab2"
...
poly_results %>% 
  ...
  geom_smooth(method = lm, # line model
              formula = y ~ poly(x, degree = 3), # speicfy polynomial line
              color = "midnightblue", 
              size = 1.2, 
              se = FALSE) +
  xlab("package")
...
print(cor(baked_pumpkins$city_name, # predictor
